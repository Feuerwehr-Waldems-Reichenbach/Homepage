            ...
            <div class="row card-box align-left">
              ...
              <div class="item features-without-image col-12 active">
                <div class="item-wrapper">
                  <h4 class="mbr-section-subtitle mbr-fonts-style mb-3 display-2"><strong>1. Verantwortlicher und
                      Überblick</strong></h4>
                  <p class="mbr-text mbr-fonts-style display-7">Verantwortlich für die Datenverarbeitung auf dieser
                    Website ist:
                    <br>
              ...
              <div class="item features-without-image col-12">
                <div class="item-wrapper">
                  ...
                  <h5 class="mbr-fonts-style display-5"><strong>2.1 Rechtsgrundlagen</strong></h5>
                  <p class="mbr-text mbr-fonts-style display-7">Wir verarbeiten Ihre Daten auf folgenden
                    Rechtsgrundlagen:</p>
                  ...
                  <p class="mbr-text mbr-fonts-style display-7">Nach Ablauf dieser Fristen werden die Daten gelöscht
              ...
              <div class="item features-without-image col-12">
                <div class="item-wrapper">
                  ...
                  <p class="mbr-text mbr-fonts-style display-7">
                  <h5 class="mbr-fonts-style display-5"><strong>3.1 Registrierung und Benutzerkonto</strong></h5>
                  <p class="mbr-text mbr-fonts-style display-7">Für die Nutzung unseres Reservierungssystems ist die
                  ...
                  <p class="mbr-text mbr-fonts-style display-7"><strong>Zweck:</strong> Verwaltung Ihres Benutzerkontos,
                  ...
                  <p class="mbr-text mbr-fonts-style display-7"><strong>Zweck:</strong> Durchführung und Verwaltung
                  ...
                  <p class="mbr-text mbr-fonts-style display-7"><strong>Zweck:</strong> Bearbeitung Ihrer Anfragen,
                    Verbesserung unseres Services.</p>
                  <p class="mbr-text mbr-fonts-style display-7"><strong>Rechtsgrundlage:</strong> Berechtigtes Interesse
                  ...
                  <p class="mbr-text mbr-fonts-style display-7"><strong>Zweck:</strong> Information über wichtige
                  ...
                  <p class="mbr-text mbr-fonts-style display-7"><strong>Zweck:</strong> Technische Bereitstellung der
                  ...
                  <p class="mbr-text mbr-fonts-style display-7"><strong>Zweck:</strong> Technische Funktionalität der
                    Website, Sicherheit, Benutzerfreundlichkeit.</p>
                  <p class="mbr-text mbr-fonts-style display-7"><strong>Rechtsgrundlage:</strong> Berechtigtes Interesse
                    an der technischen Bereitstellung der Website (Art. 6 Abs. 1 lit. f DSGVO).</p>
                  <p class="mbr-text mbr-fonts-style display-7">Die meisten Browser akzeptieren Cookies automatisch. Sie
                  ...
                  <p class="mbr-text mbr-fonts-style display-7">Bitte beachten Sie, dass Sie auch passives Mitglied des
                    ...
                    müssen.</p>
                  <p class="mbr-text mbr-fonts-style display-7"><strong>Zweck:</strong> Mitgliederverwaltung,
              ...
              <div class="item features-without-image col-12">
                <div class="item-wrapper">
                  ...
                  <p class="mbr-text mbr-fonts-style display-7">Wir treffen nach dem Stand der Technik angemessene
                  ...
                  <p class="mbr-text mbr-fonts-style display-7">Trotz dieser Maßnahmen kann keine absolut vollständige
              ...
              <div class="item features-without-image col-12">
                <div class="item-wrapper">
                  ...
                  <p class="mbr-text mbr-fonts-style display-7">
                  <h5 class="mbr-fonts-style display-5"><strong>5.1 Interne Empfänger</strong></h5>
                  ...
                  <p class="mbr-text mbr-fonts-style display-7"><strong>Zweck:</strong> Darstellung unseres Standorts
                  ...
                  <p class="mbr-text mbr-fonts-style display-7">Wenn Sie nicht möchten, dass Google über unseren
              ...
              <div class="item features-without-image col-12">
                <div class="item-wrapper">
                  ...
                  <p class="mbr-text mbr-fonts-style display-7">Dieses Recht kann unter bestimmten Umständen
                  ...
                  <p class="mbr-text mbr-fonts-style display-7">Bei Mitgliedschaftsdaten im Förderverein: Nach
              ...
              <div class="item features-without-image col-12">
                <div class="item-wrapper">
                  ...
                  <p class="mbr-text mbr-fonts-style display-7">Sie können Ihre Rechte jederzeit ausüben, indem Sie uns
                    kontaktieren:</p>
                  <ul class="mbr-text mbr-fonts-style display-7">
                  ...
                  <p class="mbr-text mbr-fonts-style display-7">Bei Anfragen zur Ausübung Ihrer Rechte bitten wir um
                    einen Identitätsnachweis, um sicherzustellen, dass Ihre Daten nicht an unbefugte Dritte
                    herausgegeben werden.</p>
                  <p class="mbr-text mbr-fonts-style display-7">In Ihrem Benutzerkonto haben Sie zudem die Möglichkeit,
