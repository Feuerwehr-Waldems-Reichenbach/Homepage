...
<head>
  ...
  <meta name="description" content="Möchtest du Teil der Freiwilligen Feuerwehr Reichenbach werden? Erfahre mehr darüber, wie du mitmachen und einen Unterschied machen kannst.">
  ...
  <link rel="preload" as="style" href="../assets/mobirise/css/mbr-additional.css?v=7TVD93"><link rel="stylesheet" href="../assets/mobirise/css/mbr-additional.css?v=7TVD93" type="text/css">
...
<section data-bs-version="5.1" class="header16 cid-u8N1tzsnVL mbr-fullscreen mbr-parallax-background" id="header17-1i">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="content-wrap col-12 col-md-12">
        ...
        <div class="mbr-section-btn"><a class="btn btn-white-outline display-7" href="Mitmachen.html#features019-1j">Erfahre mehr!</a></div>
      </div>
    </div>
  </div>
</section>
		...
		<div class="row">
				...
				<div class="item-wrapper">
					<div class="card-box align-left">
						...
						<h5 class="card-title mbr-fonts-style display-5">
							<strong>Einsatzabteilung</strong></h5>
						<p class="card-text mbr-fonts-style display-7">
							Unsere Einsatzabteilung trifft sich alle zwei Wochen montags zu Übungen. Hier bereiten wir uns auf verschiedene Einsatzszenarien vor und verbessern unsere Fähigkeiten im Team.</p>
					</div>
				</div>
			</div>
			<div class="item features-without-image col-12 col-lg-4 item-mb">
				<div class="item-wrapper">
					<div class="card-box align-left">
						<div class="img-wrapper mb-3">
							<img class="" src="../assets/images/whatsapp-bild-2024-08-13-um-19.29.12-f774f342-1.webp" alt="Jugendfeuerwehr" data-slide-to="1" data-bs-slide-to="1">
						</div>
						<h5 class="card-title mbr-fonts-style display-5">
							<strong>Jugendfeuerwehr</strong></h5>
						<p class="card-text mbr-fonts-style display-7">
							Die Jugendfeuerwehr trifft sich alle zwei Wochen dienstags. Jugendliche lernen hier spielerisch die Grundlagen der Feuerwehrarbeit und erleben spannende Aktivitäten.</p>
					</div>
				</div>
				...
				<div class="item-wrapper">
					<div class="card-box align-left">
						<div class="img-wrapper mb-3">
							<img class="" src="../assets/images/lowpoly.webp" alt="Kinderfeuerwehr" data-slide-to="2" data-bs-slide-to="2">
						</div>
						<h5 class="card-title mbr-fonts-style display-5">
							<strong>Kinderfeuerwehr</strong></h5>
						<p class="card-text mbr-fonts-style display-7">
							Die Kinderfeuerwehr trifft sich alle vier Wochen montags. Hier werden die Kinder spielerisch an die Aufgaben der Feuerwehr herangeführt und nehmen an altersgerechten Übungen und Aktivitäten teil.</p>
					</div>
				</div>
			</div>
...
<section data-bs-version="5.1" class="social02 cid-u8MJuNN8A8" id="social02-x">
