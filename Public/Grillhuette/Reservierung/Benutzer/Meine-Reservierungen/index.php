    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        // Bearbeiten einer öffentlichen Veranstaltung
            ...
            if (empty($errors)) {
                ...
                else if (strtotime($displayStartDate) < strtotime(date('Y-m-d', strtotime($reservationData['start_datetime']))) || 
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                ...
                                                <?php if (isset($res['is_public']) && $res['is_public']): ?>
                                                    <button type="button" 
                                                            ...
                                                            data-bs-target="#editPublicEventModal"
...
<div class="modal fade" id="editPublicEventModal" tabindex="-1" aria-labelledby="editPublicEventModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo getRelativePath('Benutzer/Meine-Reservierungen'); ?>" id="editPublicEventForm">
                    <input type="hidden" name="csrf_token" value="<?php echo generate_csrf_token(); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="event_name" name="event_name" maxlength="255" placeholder="z.B. Grillfest" required>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="document.getElementById('editPublicEventForm').submit();">Änderungen speichern</button>
            </div>
        </div>
    </div>
</div>
