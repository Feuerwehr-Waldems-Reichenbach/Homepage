            ...
            <div class="card-body">
                ...
                <form method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="first_name" name="first_name"
                                value="<?php echo escape($formData['first_name']); ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="last_name" class="form-label">Nachname</label>
                            <input type="text" class="form-control" id="last_name" name="last_name"
                                value="<?php echo escape($formData['last_name']); ?>" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="form-text">Ihre E-Mail-Adresse wird für die Kommunikation und Bestätigung von
                            Reservierungen verwendet.</div>
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label">Telefonnummer</label>
                        <input type="tel" class="form-control" id="phone" name="phone"
                            value="<?php echo escape($formData['phone']); ?>" required>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-3 form-check">
                        ...
                        <label class="form-check-label" for="terms">Ich akzeptiere die <a
                                href="<?php echo getRelativePath('Nutzungsbedingungen'); ?>"
                                target="_blank">Nutzungsbedingungen</a> und <a href="/Datenschutz"
                                target="_blank">Datenschutzrichtlinien</a>.</label>
                    </div>
