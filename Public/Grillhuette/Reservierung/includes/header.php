...
<body>
    <header class="bg-dark text-white">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand d-lg-welcome-separator" href="<?php echo getRelativePath('home'); ?>">Grillhütte
                    Waldems Reichenbach</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown d-none d-lg-block">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="allgemeinDropdown">
                                ...
                                <li><a class="dropdown-item" href="<?php echo getRelativePath('home'); ?>">
                                        <i class="bi bi-calendar-check me-2"></i>Kalender</a>
                                </li>
                        ...
                        <?php if (isset($_SESSION['user_id'])): ?>
                            ...
                            <li class="nav-item dropdown d-none d-lg-block">
                                <a class="nav-link dropdown-toggle" href="#" id="benutzerDropdown" role="button"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    Mein Bereich
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="benutzerDropdown">
                                    <li><a class="dropdown-item"
                                            href="<?php echo getRelativePath('Benutzer/Meine-Reservierungen'); ?>">
                            ...
                            <?php if (isset($_SESSION['is_admin']) && $_SESSION['is_admin']): ?>
                                ...
                                <li class="nav-item dropdown d-none d-lg-block">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="adminDropdown">
                                        <li><a class="dropdown-item"
                                                href="<?php echo getRelativePath('Admin/Reservierungsverwaltung'); ?>">
                                                <i class="bi bi-calendar-check me-2"></i>Reservierungen verwalten</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="<?php echo getRelativePath('Admin/Benutzerverwaltung'); ?>">
                                                <i class="bi bi-people me-2"></i>Benutzer verwalten</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="<?php echo getRelativePath('Admin/Informationsverwaltung'); ?>">
                    ...
                    <ul class="navbar-nav align-items-center">
                        <?php if (isset($_SESSION['user_id'])): ?>
                            <li class="nav-item d-none d-lg-flex welcome-item me-3">
                                <span class="nav-link user-welcome"><i class="bi bi-person-circle me-1"></i>Willkommen,
                                    <?php echo escape($_SESSION['user_name']); ?></span>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn btn-outline-light btn-sm px-3"
                                    href="<?php echo getRelativePath('Benutzer/Abmelden'); ?>">
                        ...
                        <?php else: ?>
                            <li class="nav-item me-2">
                                <a class="nav-link btn btn-outline-light btn-sm px-3"
                                    href="<?php echo getRelativePath('Benutzer/Anmelden'); ?>">
                                    <i class="bi bi-box-arrow-in-right me-1"></i>Anmelden
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn btn-primary btn-sm px-3"
                                    href="<?php echo getRelativePath('Benutzer/Registrieren'); ?>">
