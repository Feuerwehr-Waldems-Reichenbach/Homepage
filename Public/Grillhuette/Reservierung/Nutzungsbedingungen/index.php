        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>Bei der Reservierung der Grillhütte kann vom Betreiber eine Kaution verlangt werden. Die Höhe der Kaution wird dem Nutzer vor der Reservierungsbestätigung mitgeteilt.</p>
                    ...
                    <ul>
                        ...
                        <li>Bei Verstößen gegen die Nutzungsregeln (z.B. Lärmbelästigung, Überschreitung der Personenzahl)</li>
                    ...
                    <p>Die Nutzer sind verpflichtet, mit den Einrichtungen und dem Inventar der Grillhütte sorgsam umzugehen. Beschädigungen sind dem Betreiber unverzüglich zu melden.</p>
                    <p>Die Grillhütte ist nach der Nutzung in einem ordnungsgemäßen und gereinigten Zustand zu übergeben. Der anfallende Müll ist entsprechend der örtlichen Vorschriften zu entsorgen.</p>
                    ...
                    <ul>
                        ...
                        <li>Das Anbringen von Dekorationen ist nur mit rückstandslos entfernbaren Befestigungsmitteln gestattet</li>
                        <li>Die Nutzung von Feuerwerkskörpern ist nur mit vorheriger Genehmigung und unter Einhaltung der gesetzlichen Bestimmungen erlaubt</li>
                    </ul>
                    ...
                    <p>Der Betreiber bemüht sich, das Reservierungssystem kontinuierlich verfügbar zu halten, kann jedoch keine ununterbrochene Verfügbarkeit garantieren. Insbesondere bei Wartungsarbeiten, technischen Problemen oder höherer Gewalt kann es zu vorübergehenden Ausfällen kommen.</p>
                    <p>Der Nutzer erkennt an, dass eine 100%ige Verfügbarkeit technisch nicht realisierbar ist. Der Betreiber haftet nicht für Schäden, die durch die Nichtverfügbarkeit des Systems entstehen.</p>
                    <p>Sollte das Reservierungssystem aus technischen Gründen nicht verfügbar sein, können Reservierungsanfragen auch per E-Mail oder telefonisch gestellt werden.</p>
                    
                    <h2 class="h4">9. Änderungen der Nutzungsbedingungen</h2>
                    <p>Der Betreiber behält sich das Recht vor, diese Nutzungsbedingungen jederzeit zu ändern. Die Nutzer werden über Änderungen per E-Mail oder beim nächsten Login informiert. Die geänderten Nutzungsbedingungen gelten als angenommen, wenn der Nutzer nicht innerhalb von 14 Tagen nach Bekanntgabe der Änderungen widerspricht.</p>
                    ...
                    <p>Verbraucher haben grundsätzlich ein 14-tägiges Widerrufsrecht. Da es sich bei der Reservierung der Grillhütte um eine Dienstleistung im Bereich der Freizeitgestaltung mit einem spezifischen Termin handelt, ist das Widerrufsrecht gemäß § 312g Abs. 2 Nr. 9 BGB ausgeschlossen. Es gelten stattdessen die oben genannten Stornierungsbedingungen.</p>
                    
                    <h2 class="h4">11. Schlussbestimmungen</h2>
                    <p>Sollten einzelne Bestimmungen dieser Nutzungsbedingungen ungültig sein oder werden, bleibt die Gültigkeit der übrigen Bestimmungen unberührt. An die Stelle der unwirksamen Bestimmung tritt eine Regelung, die dem wirtschaftlichen Zweck der unwirksamen Bestimmung am nächsten kommt.</p>
                    <p>Es gilt ausschließlich das Recht der Bundesrepublik Deutschland unter Ausschluss des UN-Kaufrechts. Gerichtsstand ist, soweit gesetzlich zulässig, der Sitz des Betreibers.</p>
                    <p>Mündliche Nebenabreden bestehen nicht. Änderungen oder Ergänzungen dieses Vertrages bedürfen der Textform.</p>
                    <p>Mit der Abgabe einer Reservierungsanfrage bestätigt der Nutzer, diese Nutzungsbedingungen gelesen, verstanden und akzeptiert zu haben.</p>
