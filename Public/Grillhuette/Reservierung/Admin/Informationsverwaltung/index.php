    ...
    <div class="col-md-12">
            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="infoTabsContent">
                    ...
                    <div class="tab-pane fade <?php echo $isActive ? 'show active' : ''; ?>" 
                        ...
                        <div class="mt-3 mb-4">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addInfoModal<?php echo $category; ?>">
                                        ...
                                        <div class="card-body">
                                            <form method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="info_content_<?php echo $info['id']; ?>" name="info_content" rows="3" <?php echo $category === $systemCategory ? '' : ''; ?>><?php echo htmlspecialchars($info['content']); ?></textarea>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                ?>
                <h5 class="card-title"><?php echo $systemInfos['WillkommensText'] ?? 'Willkommen im Reservierungssystem der Grillhütte Waldems Reichenbach'; ?></h5>
                <p><?php echo $systemInfos['WillkommensUntertext'] ?? 'Hier können Sie freie Termine einsehen und eine Reservierung vornehmen.'; ?></p>
                
                <hr>
                
                <h5 class="card-title">Informationen zur Grillhütte</h5>
                <ul class="list-unstyled">
                    <li><strong>Miete:</strong> <?php echo $systemInfos['MietpreisNormal'] ?? '100€'; ?> pro Tag (<?php echo $systemInfos['UebergabeZeit'] ?? '12 - 12 Uhr'; ?>)</li>
                ...
                <p><?php echo $systemInfos['VerwaltungspersonVorname'] ?? 'Julia'; ?> <?php echo $systemInfos['VerwaltungspersonNachname'] ?? 'Kitschmann'; ?></p>
...
<div class="modal fade" id="addInfoModal<?php echo $category; ?>" tabindex="-1" aria-labelledby="addInfoModal<?php echo $category; ?>Label" aria-hidden="true">
            ...
            <div class="modal-body">
                <form method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="info_title_<?php echo $category; ?>" name="info_title" required>
                        <div class="form-text">
                            <?php
                            $titleHelp = '';
                            $categoryPrefix = '';
                            ...
                            <br><strong>Hinweis:</strong> Der Schlüssel muss eindeutig sein und darf nicht bereits existieren.
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="info_content_<?php echo $category; ?>" name="info_content" rows="3" required
                            placeholder="<?php 
                            switch ($category) {
                                case 'grillhuette_info':
