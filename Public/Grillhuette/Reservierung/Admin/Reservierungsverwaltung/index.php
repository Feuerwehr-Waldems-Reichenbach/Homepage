            ...
            <div class="card-header">
                <div
                    ...
                    <div class="btn-group btn-group-sm flex-wrap filter-buttons">
                        <a href="<?php echo getRelativePath('Admin/Reservierungsverwaltung'); ?>"
                            class="btn btn-outline-secondary <?php echo $statusFilter === 'all' ? 'active' : ''; ?>">Alle</a>
                        <a href="<?php echo getRelativePath('Admin/Reservierungsverwaltung'); ?>?status=pending"
                            class="btn btn-outline-warning <?php echo $statusFilter === 'pending' ? 'active' : ''; ?>">Ausstehend</a>
                        <a href="<?php echo getRelativePath('Admin/Reservierungsverwaltung'); ?>?status=confirmed"
                            class="btn btn-outline-success <?php echo $statusFilter === 'confirmed' ? 'active' : ''; ?>">Bestätigt</a>
                        <a href="<?php echo getRelativePath('Admin/Reservierungsverwaltung'); ?>?status=canceled"
                            class="btn btn-outline-danger <?php echo $statusFilter === 'canceled' ? 'active' : ''; ?>">Storniert</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                                ...
                                <?php foreach ($allReservations as $res): ?>
                                    <tr>
                                                ...
                                                <div class="mt-2 small">
                                                    <span class="d-block text-primary">
                                                        ...
                                                        <?php if (!empty($res['key_handover_datetime'])): ?>
                                                            <span class="me-2">Übergabe:
                                                                <?php echo date('d.m.Y H:i', strtotime($res['key_handover_datetime'])); ?></span>
                                                        <?php endif; ?>
                                                        <?php if (!empty($res['key_return_datetime'])): ?>
                                                            <span>Rückgabe:
                                                                <?php echo date('d.m.Y H:i', strtotime($res['key_return_datetime'])); ?></span>
                                                        <?php endif; ?>
                                                    </span>
                                                </div>
                                            <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <small>(<?php echo $daysCount; ?> Tage ×
                                                <?php echo $formattedBasePrice; ?>€)</small>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#editReservationModal" data-id="<?php echo $res['id']; ?>"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post"
                    action="<?php echo getRelativePath('Admin/Reservierungsverwaltung'); ?><?php echo $statusFilter !== 'all' ? '?status=' . $statusFilter : ''; ?>"
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="receipt_requested" name="receipt_requested"
                            value="1">
                        <label class="form-check-label" for="receipt_requested">Quittung für die Reservierung
                            gewünscht</label>
                    </div>
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="is_public" name="is_public" value="1">
                        <label class="form-check-label" for="is_public">Öffentliche Reservierung (im Kalender
                            sichtbar)</label>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <div class="form-text mb-3">Der Schlüssel wird standardmäßig am Tag vor dem Aufenthalt um
                                16:00 Uhr übergeben und am Tag nach dem Aufenthalt um 12:00 Uhr zurückgenommen.</div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="key_handover_date" class="form-label">Datum Schlüsselübergabe</label>
                            <input type="text" class="form-control date-picker" id="key_handover_date"
                                name="key_handover_date">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="key_handover_time" class="form-label">Uhrzeit Schlüsselübergabe</label>
                            <input type="time" class="form-control" id="key_handover_time" name="key_handover_time"
                                value="16:00">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="key_return_date" class="form-label">Datum Schlüsselrückgabe</label>
                            <input type="text" class="form-control date-picker" id="key_return_date"
                                name="key_return_date">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="key_return_time" class="form-label">Uhrzeit Schlüsselrückgabe</label>
                            <input type="time" class="form-control" id="key_return_time" name="key_return_time"
                                value="12:00">
                        </div>
                    </div>
                    <!-- Kostenübersicht -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <ul class="list-unstyled mb-0" id="new-cost-overview"
                                                data-base-price="<?php echo $priceInfo['base_price']; ?>">
                                                <?php
                                                ...
                                                ?>
                                                <li>Grundpreis: <span class="daily-rate"
                                                        data-base-price="<?php echo $basePriceRaw; ?>"><?php echo $basePrice; ?>€</span>
                                                    pro Tag</li>
                                                <li>Anzahl Tage: <span id="new-day-count">1</span></li>
                                                <li class="border-top mt-2 pt-2"><strong>Gesamtpreis: <span
                                                            id="new-total-cost"><?php echo $basePrice; ?>€</span></strong>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-md-6">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="createReservationButton">Reservierung
                    erstellen</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
                ...
                <form method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control date-picker" id="edit_start_date" name="start_date"
                                required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="edit_end_date" class="form-label">Enddatum</label>
                            <input type="text" class="form-control date-picker" id="edit_end_date" name="end_date"
                                required>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control" id="edit_admin_message" name="admin_message"
                                rows="3"></textarea>
                        </div>
                    </div>
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="edit_receipt_requested"
                            name="receipt_requested" value="1">
                        <label class="form-check-label" for="edit_receipt_requested">Quittung für die Reservierung
                            gewünscht</label>
                    </div>
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="edit_is_public" name="is_public" value="1">
                        <label class="form-check-label" for="edit_is_public">Öffentliche Reservierung (im Kalender
                            sichtbar)</label>
                    </div>
                    <div id="edit_public-event-details" style="display: none;">
                        ...
                        <div class="mb-3 form-check">
                            ...
                            <label class="form-check-label" for="edit_show_date_range">Veranstaltung geht über mehrere
                                Tage</label>
                        </div>
                        ...
                        <div id="edit_date-range-fields" style="display: none;">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control date-picker" id="edit_display_start_date"
                                    name="display_start_date">
                            </div>
                            <div class="mb-3">
                                <label for="edit_display_end_date" class="form-label">Anzeige im Kalender bis</label>
                                <input type="text" class="form-control date-picker" id="edit_display_end_date"
                                    name="display_end_date">
                                <div class="form-text">In diesem Zeitraum wird die Veranstaltung im Kalender angezeigt.
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control date-picker" id="edit_key_handover_date"
                                name="key_handover_date">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="edit_key_handover_time" class="form-label">Uhrzeit Schlüsselübergabe</label>
                            <input type="time" class="form-control" id="edit_key_handover_time"
                                name="key_handover_time">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="edit_key_return_date" class="form-label">Datum Schlüsselrückgabe</label>
                            <input type="text" class="form-control date-picker" id="edit_key_return_date"
                                name="key_return_date">
                        </div>
                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <ul class="list-unstyled mb-0" id="edit-cost-overview"
                                                ...
                                                <li class="border-top mt-2 pt-2"><strong>Gesamtpreis: <span
                                                            id="edit-total-cost"><?php echo $basePrice; ?>€</span></strong>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-md-6">
            ...
            <div class="modal-footer">
                <div class="d-flex justify-content-between w-100">
                    <div>
                        <button type="button" id="deleteReservationBtn" class="btn btn-danger">Reservierung
                            löschen</button>
                    </div>
                    <div>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Abbrechen</button>
                        <button type="button" class="btn btn-primary" id="saveReservationChangesButton">Änderungen
                            speichern</button>
                    </div>
                </div>
            </div>
...
<form method="post"
    action="<?php echo getRelativePath('Admin/Reservierungsverwaltung'); ?><?php echo $statusFilter !== 'all' ? '?status=' . $statusFilter : ''; ?>"
    id="deleteReservationForm" style="display: none;">
    <input type="hidden" name="csrf_token" value="<?php echo generate_csrf_token(); ?>">
