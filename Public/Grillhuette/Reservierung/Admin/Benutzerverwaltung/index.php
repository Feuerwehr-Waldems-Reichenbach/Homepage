                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#editUserModal" data-id="<?php echo $userItem['id']; ?>"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3 d-flex align-items-start">
                            <div class="form-check">
                                ...
                                <div class="form-text">Wenn aktiviert, kann sich der Benutzer sofort einloggen ohne
                                    E-Mail-Bestätigung.</div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3 d-flex flex-column">
                            <div class="form-check mt-1">
                                <input type="checkbox" class="form-check-input" id="is_aktivesmitglied"
                                    name="is_AktivesMitglied">
                                <label class="form-check-label" for="is_aktivesmitglied">Aktives Mitglied</label>
                                <div class="form-text">Ermöglicht vergünstigte Buchungen (<?php echo $aktivesPrice; ?>€
                                    pro Tag).</div>
                            </div>
                            <div class="form-check mt-2">
                                ...
                                <div class="form-text">Ermöglicht vergünstigte Buchungen
                                    (<?php echo $feuerwehrPrice; ?>€ pro Tag).</div>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="modal-content">
                ...
                <form method="post" id="editUserForm">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-text">Lassen Sie dieses Feld leer, um das Passwort nicht zu ändern.
                                Andernfalls mindestens 8 Zeichen mit Groß- und Kleinbuchstaben, Zahlen und mindestens
                        ...
                        <div class="col-md-6 mb-3 d-flex flex-column justify-content-around">
                            ...
                            <div class="form-check mt-2">
                                <input type="checkbox" class="form-check-input" id="edit_is_verified"
                                    name="is_verified">
                                <label class="form-check-label" for="edit_is_verified">Benutzer verifiziert</label>
                                <div class="form-text">Wenn aktiviert, kann sich der Benutzer einloggen ohne
                                    E-Mail-Bestätigung.</div>
                            </div>
                            <div class="form-check mt-2">
                                <input type="checkbox" class="form-check-input" id="edit_is_aktivesmitglied"
                                    name="is_AktivesMitglied">
                            ...
                            <div class="form-check mt-2">
                                <input type="checkbox" class="form-check-input" id="edit_is_feuerwehr"
                                    name="is_Feuerwehr">
            ...
            <div class="modal-footer">
                <div class="d-flex justify-content-between w-100">
                    ...
                    <div>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Abbrechen</button>
                        <button type="button" class="btn btn-primary" id="saveUserChangesButton">Änderungen
                            speichern</button>
                    </div>
                </div>
            </div>
