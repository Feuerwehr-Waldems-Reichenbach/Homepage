...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <p>Die Protokollbereinigung erfolgt automatisch beim Besuch der Benutzerverwaltungsseite. Sie können die Wartung hier aber auch manuell starten.</p>
        ...
        <div class="alert alert-info">
            ...
            <p>Die Sicherheitsprotokolle dienen zum Schutz der Anwendung und ihrer Benutzer vor potenziellen Angriffen.</p>
            <p>Die Speicherung dieser Daten erfolgt gemäß der DSGVO, wobei nur die notwendigen Informationen für einen angemessenen Zeitraum aufbewahrt werden.</p>
