            ...
            <div class="col-12 col-lg-8 mb-4">
                <div class="calendar-container">
                    <style>
                        ...
                        .day.public-event {
                            ...
                            /* Grün-bläuliche Farbe für öffentliche Events */
                            color: #333;
                            position: relative;
                        }
                            ...
                            <div class="d-flex flex-wrap mobile-legend">
                                <div class="me-3 mb-2">
                                    <div class="d-flex align-items-center">
                                        <div class="me-1"
                                            style="width: 15px; height: 15px; background-color: #d4edda; border-radius: 3px;">
                                        </div>
                                        <small>Frei</small>
                                    </div>
                                </div>
                                <div class="me-3 mb-2">
                                    <div class="d-flex align-items-center">
                                        <div class="me-1"
                                            style="width: 15px; height: 15px; background-color: #fff3cd; border-radius: 3px;">
                                        </div>
                                ...
                                <div class="me-3 mb-2">
                                    <div class="d-flex align-items-center">
                                        <div class="me-1"
                                            style="width: 15px; height: 15px; background-color: #f8d7da; border-radius: 3px;">
                                        </div>
                                        <small>Belegt</small>
                                    </div>
                                </div>
                                <div class="me-3 mb-2">
                                    <div class="d-flex align-items-center">
                                        <div class="me-1 public-event-indicator"
                                            style="width: 15px; height: 15px; background-color: #b8e0d2; border-radius: 3px;">
                                        </div>
                                ...
                                <div class="mb-2">
                                    <div class="d-flex align-items-center">
                                        <div class="me-1"
                                            style="width: 15px; height: 15px; background-color: #cce5ff; border-radius: 3px; display: flex; align-items: center; justify-content: center;">
                                            <i class="bi bi-key" style="font-size: 8px;"></i></div>
                ...
                <div class="card mb-4 d-none d-lg-block">
                    <div class="card-body">
                        ...
                        ?>
                        <h5 class="card-title">
                            <?php echo $infoData['WillkommensText'] ?? 'Willkommen im Reservierungssystem der Grillhütte Waldems Reichenbach'; ?>
                        </h5>
                        <p><?php echo $infoData['WillkommensUntertext'] ?? 'Hier können Sie freie Termine einsehen und eine Reservierung vornehmen.'; ?>
                        </p>
                        <div class="row mb-3">
                            <div class="col-md-3 mb-2">
                                <div class="d-flex align-items-center">
                                    <div class="me-2"
                                        style="width: 20px; height: 20px; background-color: #d4edda; border-radius: 3px;">
                                    </div>
                                    <span>Frei</span>
                                </div>
                            </div>
                            <div class="col-md-3 mb-2">
                                <div class="d-flex align-items-center">
                                    <div class="me-2"
                                        style="width: 20px; height: 20px; background-color: #fff3cd; border-radius: 3px;">
                                    </div>
                                    <span>Angefragt</span>
                                </div>
                            </div>
                            <div class="col-md-3 mb-2">
                                <div class="d-flex align-items-center">
                                    <div class="me-2"
                                        style="width: 20px; height: 20px; background-color: #f8d7da; border-radius: 3px;">
                                    </div>
                                    <span>Belegt</span>
                                </div>
                            </div>
                            <div class="col-md-3 mb-2">
                                <div class="d-flex align-items-center">
                                    <div class="me-2"
                                        style="width: 20px; height: 20px; background-color: #b8e0d2; border-radius: 3px;">
                                    </div>
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="d-flex align-items-center">
                                    <div class="me-2"
                                        style="width: 20px; height: 20px; background-color: #cce5ff; border-radius: 3px; display: flex; align-items: center; justify-content: center;">
                        ...
                        <ul class="list-unstyled">
                            <li><strong>Miete:</strong> <?php echo $basePrice; ?>€ pro Tag
                                (<?php echo $infoData['UebergabeZeit'] ?? '12 - 12 Uhr'; ?>)</li>
                            <li><strong>Kaution:</strong> <?php echo $depositAmount; ?>€</li>
                            <li><strong>Rückgabe:</strong>
                                <?php echo $infoData['RueckgabeText'] ?? 'bis spätestens am nächsten Tag 12:00 Uhr'; ?>
                            </li>
                            <li><strong>Min. Buchungszeitraum:</strong>
                                <?php echo $infoData['MinBuchungszeitraum'] ?? '1 Tag'; ?></li>
                            <?php
                        ...
                        <ul>
                            ...
                            if (!empty($imPreisEnthalten)) {
                                ...
                                <li><?php echo $infoData['ImPreisEnthaltenBiertische'] ?? '5 Biertisch-Garnituren, jede weitere Garnitur zzgl. 1€'; ?>
                                </li>
                            <?php } ?>
                        </ul>
                        ...
                        <div class="mt-3">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="javascript:void(0)" class="email-protect"
                                        ...
                                        anzeigen</a></li>
                                <li><a href="javascript:void(0)" class="phone-protect"
                        ...
                        <div class="mt-3 alert alert-secondary">
                            <p class="mb-0"><strong>Hinweis:</strong> Bei technischen Problemen mit dem
                                Reservierungssystem wenden Sie sich bitte an: <a href="javascript:void(0)"
                                    class="email-protect"
                                    data-encoded="<?php echo base64_encode($infoData['SystemEmailProbleme'] ?? 'hilfe@feuerwehr-waldems-reichenbach.de'); ?>">IT-Support</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="reservationForm" method="post" action="<?php echo getRelativePath('Erstellen'); ?>">
                                ...
                                <div class="mb-3">
                                    <label for="start_date" class="form-label"><strong>Ab wann?</strong> (Erster
                                        Tag)</label>
                                ...
                                <div class="mb-3">
                                    <label for="end_date" class="form-label"><strong>Bis wann?</strong> (Letzter
                                        Tag)</label>
                                    <input type="text" class="form-control" id="end_date" name="end_date" readonly required>
                                    <div class="form-text">Dies ist der letzte Tag Ihrer Nutzung. Für nur einen Tag wählen
                                        Sie den gleichen Tag wie oben.</div>
                                </div>
                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" id="receipt_requested"
                                        name="receipt_requested" value="1">
                                    <label class="form-check-label" for="receipt_requested"><strong>Quittung
                                            gewünscht?</strong></label>
                                    <div class="form-text">Setzen Sie hier einen Haken, wenn Sie eine Quittung für Ihre
                                        Zahlung benötigen.</div>
                                </div>
                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" id="is_public" name="is_public"
                                        value="1">
                                    <label class="form-check-label" for="is_public"><strong>Öffentliche
                                            Veranstaltung?</strong></label>
                                    <div class="form-text">Setzen Sie hier einen Haken, wenn Ihre Veranstaltung öffentlich
                                        ist und im Kalender für alle sichtbar sein soll.</div>
                                </div>
                                <div id="public-event-details" style="display: none;">
                                    ...
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" class="form-check-input" id="show_date_range"
                                            name="show_date_range">
                                        <label class="form-check-label" for="show_date_range"><strong>Veranstaltung länger
                                                als einen Tag?</strong></label>
                                        <div class="form-text">Setzen Sie hier einen Haken, wenn Ihre Veranstaltung an
                                            mehreren Tagen stattfindet.</div>
                                    </div>
                                    <div id="single-day-field" class="mb-3">
                                        <label for="event_day" class="form-label"><strong>An welchem Tag findet die
                                                Veranstaltung statt?</strong></label>
                                        <input type="text" class="form-control date-picker" id="event_day" name="event_day">
                                        <div class="form-text">Wählen Sie den Tag, an dem Ihre Veranstaltung im Kalender
                                            angezeigt werden soll.</div>
                                    </div>
                                    <div id="date-range-fields" style="display: none;">
                                        <div class="mb-3">
                                            <label for="display_start_date" class="form-label"><strong>Erster
                                                    Veranstaltungstag</strong></label>
                                            <input type="text" class="form-control date-picker" id="display_start_date"
                                                name="display_start_date">
                                            <div class="form-text">Ab diesem Tag wird Ihre Veranstaltung im Kalender
                                                angezeigt.</div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="display_end_date" class="form-label"><strong>Letzter
                                                    Veranstaltungstag</strong></label>
                                            <input type="text" class="form-control date-picker" id="display_end_date"
                                                name="display_end_date">
                                            <div class="form-text">Bis zu diesem Tag wird Ihre Veranstaltung im Kalender
                                                angezeigt.</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="message" class="form-label"><strong>Haben Sie besondere Wünsche oder
                                            Anmerkungen?</strong> (freiwillig)</label>
                                    <textarea class="form-control" id="message" name="message" rows="3"></textarea>
                                    <div class="form-text">Hier können Sie zusätzliche Informationen für die Verwaltung
                                        angeben.</div>
                                </div>
                                <!-- Kostenübersicht -->
                                <div class="mb-3">
                                    ...
                                    <div class="card">
                                        <div class="card-body p-3">
                                            ...
                                            <ul class="list-unstyled mb-0" id="cost-overview"
                                                data-user-rate="<?php echo $userRateRaw; ?>">
                                                <li>Grundpreis: <span id="base-cost"><?php echo $userRate; ?>€</span> pro
                                                    Tag</li>
                                                <li>Anzahl Tage: <span id="day-count">1</span></li>
                                                <li class="border-top mt-2 pt-2"><strong>Gesamtpreis: <span
                                                            id="total-cost"><?php echo $userRate; ?>€</span></strong></li>
                                                <?php if (isset($_SESSION['is_Feuerwehr']) && $_SESSION['is_Feuerwehr']): ?>
                                                    <li class="special-price-note text-success mt-2"><i
                                                            class="bi bi-check-circle"></i> Spezialpreis für Feuerwehr (0€)</li>
                                                <?php endif; ?>
                                            </ul>
                                            <div class="form-text mt-2">Kaution (<?php echo $depositAmount; ?>€) nicht im
                                                Gesamtpreis enthalten.</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="alert alert-info mb-4">
                                <p>Um eine Reservierung vornehmen zu können, müssen Sie angemeldet sein und Ihre
                                    E-Mail-Adresse bestätigt haben.</p>
                            </div>
                            <div class="d-grid gap-2">
                                <a href="<?php echo getRelativePath('Benutzer/Anmelden'); ?>"
                                    class="btn btn-primary">Anmelden</a>
                                <a href="<?php echo getRelativePath('Benutzer/Registrieren'); ?>"
                                    class="btn btn-outline-primary">Registrieren</a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                                        ...
                                        <div class="accordion-body">
                                            <ul class="mb-0">
                                                ...
                                                if (!empty($imPreisEnthalten)) {
                                                    ...
                                                    ?>
                                                    <li><?php echo $infoData['ImPreisEnthaltenWasser'] ?? '1m³ Wasser'; ?>
                                                    </li>
                                                    <li><?php echo $infoData['ImPreisEnthaltenStrom'] ?? '5 kW/h Strom'; ?>
                                                    </li>
                                                    <li><?php echo $infoData['ImPreisEnthaltenBiertische'] ?? '5 Biertisch-Garnituren, jede weitere Garnitur zzgl. 1€'; ?>
                                                    </li>
                                                <?php } ?>
                                        ...
                                        <div class="accordion-body">
                                            <ul class="mb-0">
                                                ...
                                                if (!empty($wichtigeHinweise)) {
                                                    ...
                                                    <li><?php echo $infoData['WichtigerHinweis4'] ?? 'Müll ist selbst zu entsorgen'; ?>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                <li><a href="javascript:void(0)" class="email-protect"
                                                        ...
                                                        anzeigen</a></li>
                                                <li><a href="javascript:void(0)" class="phone-protect"
                                                        data-encoded="<?php echo base64_encode($infoData['VerwaltungspersonTelefon'] ?? '0178/8829055'); ?>">Telefon
                                                        anzeigen</a></li>
                                            </ul>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Um eine Reservierung vornehmen zu können, müssen Sie angemeldet sein und Ihre E-Mail-Adresse
                        bestätigt haben.</p>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <a href="<?php echo getRelativePath('Benutzer/Anmelden'); ?>" class="btn btn-primary"
                        style="min-width: 120px;">Anmelden</a>
                    <a href="<?php echo getRelativePath('Benutzer/Registrieren'); ?>" class="btn btn-outline-primary"
                        style="min-width: 120px;">Registrieren</a>
                </div>
            </div>
        </div>
    </div>
...
<div id="guideTip" class="guide-tip">
    ...
    <div id="guideStepContent" class="guide-tip-content">
        Schauen Sie sich den Kalender an, um verfügbare Tage zu sehen. Grün markierte Tage sind verfügbar. Sie können
        mit den Pfeilen zwischen den Monaten wechseln.
    </div>
...
<style>
    ...
    .guide-tip {
        ...
        display: none;
        width: 350px;
        /* Erhöhte Breite für bessere Lesbarkeit */
        background-color: white;
        border: 2px solid #007bff;
        /* Dickerer Rahmen mit deutlicherer Farbe */
        border-radius: 8px;
        box-shadow: 0 6px 16px rgba(0, 0, 0, 0.2);
        z-index: 1000;
        font-size: 16px;
        /* Größere Standardschrift */
    ...
    .guide-tip-content {
        padding: 16px;
        /* Größerer Innenabstand */
        line-height: 1.6;
        /* Erhöhter Zeilenabstand für bessere Lesbarkeit */
    }
    ...
    .close-btn {
        ...
        border: none;
        font-size: 24px;
        /* Größeres Schließen-Symbol */
        color: white;
        /* Weißes Symbol für besseren Kontrast */
        cursor: pointer;
        padding: 0;
        line-height: 1;
    }
    ...
    .highlight-element {
        ...
        /* Sicherstellen, dass Mausinteraktionen funktionieren */
    }
    ...
    .overlay-backdrop {
        ...
        display: none;
        pointer-events: none;
        /* Permits clicks through the overlay */
    }
    ...
    @media (max-width: 768px) {
        .guide-tip {
            width: 320px;
            /* Größer aber angepasst für Mobilgeräte */
            position: fixed;
            bottom: 80px;
            left: 50%;
            transform: translateX(-50%);
            font-size: 16px;
            /* Größere Schrift auch auf Mobilgeräten */
        }

        .guide-buttons button {
            padding: 10px 16px;
            /* Noch größere Touch-Targets auf Mobilgeräten */
        }
    }
    ...
    @media (max-width: 375px) {
        .guide-tip {
            width: 90%;
            /* Relative Breite statt fester Breite */
            bottom: 60px;
            /* Höher positionieren, damit mehr Inhalte sichtbar sind */
            max-height: 60vh;
            /* Maximal 60% der Bildschirmhöhe */
            overflow-y: auto;
            /* Scrollbar, wenn der Inhalt nicht passt */
            font-size: 14px;
        ...
        .guide-tip-multi-hints {
            padding: 12px;
            /* Kleineres Padding für Inhalt */
        }

        .guide-tip-footer {
            padding: 10px;
            /* Kleineres Padding für Footer */
        }
        ...
        .highlight-element {
            ...
            border-width: 2px !important;
            /* Etwas dünnerer Rahmen für mobil */
            box-shadow: 0 0 8px rgba(0, 123, 255, 0.5) !important;
            /* Weniger intensive Schatten */
        }
