        ...
        <div class="col-lg-9">
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <h2 class="mb-0">Benutzeranleitung für das Reservierungssystem der Grillhütte Waldems Reichenbach
                    </h2>
                </div>
                <div class="card-body">
                    <div id="einfuehrung" class="mb-5">
                        ...
                        <hr>
                        <p>
                            Willkommen zur Benutzeranleitung des Reservierungssystems der Grillhütte Waldems
                            Reichenbach.
                        ...
                        <div class="alert alert-info">
                            ...
                            sich registrieren und Ihre E-Mail-Adresse bestätigen. Die Anmelde- und
                            Registrierungsschaltflächen
                            finden Sie oben rechts in der Navigationsleiste.
                        </div>
                        <h4 class="mt-4">Systemanforderungen</h4>
                        <p>
                            Das Reservierungssystem ist mit allen modernen Webbrowsern kompatibel (Chrome, Firefox,
                            Safari, Edge).
                    ...
                    <div id="benutzer-registrierung" class="mb-5">
                        ...
                        <ol class="mb-4">
                            <li>Klicken Sie auf den Button <strong>"Registrieren"</strong> in der oberen
                            ...
                            <li>Klicken Sie auf <strong>"Registrieren"</strong>, um den Registrierungsprozess
                                abzuschließen.</li>
                            <li>Nach der Registrierung erhalten Sie eine Bestätigungs-E-Mail mit einem Aktivierungslink.
                            </li>
                            <li>Klicken Sie auf den Aktivierungslink in der E-Mail, um Ihr Konto zu verifizieren.</li>
                        </ol>
                        <div class="alert alert-warning">
                            <strong>Hinweis:</strong> Sie können erst nach erfolgreicher Verifizierung Ihrer
                            E-Mail-Adresse
                    ...
                    <div id="benutzer-anmeldung" class="mb-5">
                        ...
                        <hr>
                        <p>Nach erfolgreicher Registrierung können Sie sich mit Ihrer E-Mail-Adresse und Ihrem Passwort
                            anmelden:</p>
                        <ol>
                    ...
                    <div id="profil-verwalten" class="mb-5">
                        ...
                        <ol>
                            <li>Im Dropdown-Menü <strong>"Mein Bereich"</strong> auf <strong>"Mein Profil"</strong>
                                klicken.</li>
                            ...
                            <li>Nach Änderungen auf <strong>"Aktualisieren"</strong> bzw. <strong>"Speichern"</strong>
                                klicken, um die Änderungen zu übernehmen.</li>
                        </ol>
                        <div class="alert alert-info">
                            <strong>Hinweis:</strong> Bei Änderung Ihrer E-Mail-Adresse müssen Sie diese erneut
                            verifizieren,
                            bevor Sie weitere Reservierungen vornehmen können. Nach der Änderung werden Sie automatisch
                            abgemeldet.
                        </div>
                    ...
                    <div id="passwort-zuruecksetzen" class="mb-5">
                        ...
                        <ol>
                            ...
                            <li>Geben Sie Ihre E-Mail-Adresse ein und klicken Sie auf <strong>"Passwort
                                    zurücksetzen"</strong>.</li>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-start mt-4">
                            <a href="<?php echo getRelativePath('Benutzer/Passwort-vergessen'); ?>"
                    ...
                    <div id="reservierung-uebersicht" class="mb-5">
                        ...
                        <p>
                            ...
                            reservierten Terminen für die Grillhütte. Sie erreichen diese Seite über den Menüpunkt
                    ...
                    <div id="reservierung-erstellen" class="mb-5">
                        ...
                        <ol>
                            ...
                            <li>Optional: Setzen Sie einen Haken bei "Quittung gewünscht", wenn Sie eine Quittung
                                benötigen.</li>
                            <li>Optional: Für öffentliche Veranstaltungen:
                                <ul>
                                    ...
                                    <li>Legen Sie den Tag bzw. Zeitraum fest, an dem die Veranstaltung angezeigt werden
                                        soll</li>
                                </ul>
                            </li>
                        ...
                        <div class="alert alert-info">
                            ...
                            verbindlich ist. Der Status Ihrer Reservierung wird im Kalender zunächst als "angefragt"
                            (gelb) angezeigt.
                        </div>
                        <h5 class="mt-4">Reservierungshilfe nutzen</h5>
                        <p>
                            Das System bietet eine interaktive Reservierungshilfe, die Sie durch den
                            Reservierungsprozess führt:
                        </p>
                        <ol>
                            ...
                            <li>Sie werden durch alle notwendigen Eingaben geführt und erhalten hilfreiche Hinweise.
                            </li>
                        </ol>
                    ...
                    <div id="meine-reservierungen" class="mb-5">
                        ...
                        <ol>
                            <li>Klicken Sie nach der Anmeldung im Dropdown-Menü <strong>"Mein Bereich"</strong> auf
                                <strong>"Meine Reservierungen"</strong>.</li>
                            <li>Auf der Seite "Meine Reservierungen" sehen Sie:
                                <ul>
                                    ...
                                    <li>Alle Details zu jeder Reservierung (Zeitraum, Kosten, Schlüsselübergabezeiten,
                                        etc.)</li>
                                </ul>
                            </li>
                        </ol>
                        ...
                        <div class="alert alert-warning">
                            <strong>Hinweis:</strong> Eine Stornierung ist für alle Reservierungen möglich, die in der
                            Zukunft liegen.
                            Vergangene oder stornierte Reservierungen können vollständig gelöscht werden.
                        </div>
                        <?php if (isset($_SESSION['user_id'])): ?>
                            <div class="d-grid gap-2 d-md-flex justify-content-md-start mt-4">
                                <a href="<?php echo getRelativePath('Benutzer/Meine-Reservierungen'); ?>"
                                    class="btn btn-primary">
                    ...
                    <div id="oeffentliche-veranstaltungen" class="mb-5">
                        ...
                        <p>
                            Nach Bestätigung durch die Verwaltung wird Ihre Veranstaltung im Kalender in einer
                            speziellen
                        ...
                        <div class="alert alert-info">
                            <strong>Hinweis:</strong> Öffentliche Veranstaltungen sind ein guter Weg, um andere über
                            Ihre
                            Veranstaltung zu informieren. Der Name der Veranstaltung wird im Kalender angezeigt. Die
                            Anzeigedaten können
                            von Ihren tatsächlichen Reservierungsdaten abweichen, müssen aber innerhalb des
                    ...
                    <div id="kontakt" class="mb-5">
                        ...
                        <hr>
                        <p>
                            Bei Fragen oder Problemen mit dem Reservierungssystem können Sie folgende
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-start mt-4">
                            <a href="mailto:<?php echo $infoData['SystemEmailProbleme'] ?? 'hilfe@feuerwehr-waldems-reichenbach.de'; ?>"
                                class="btn btn-primary">
                        ...
                        <div class="accordion" id="faqAccordion">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        Entscheidung
                                        informiert. Im Kalender wird Ihre Reservierung zunächst als "angefragt" (gelb)
                                        und
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                    data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Ja, Sie können auch bestätigte Reservierungen stornieren, solange der Termin in
                                        der
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                    data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Ein als "Schlüsselübergabe" markierter Tag bedeutet, dass die Hütte nur
                                        eingeschränkt
                                        nutzbar ist, da an diesem Tag eine Übergabe stattfindet. Die genauen Zeiten
                                        können
                                        Sie sehen, wenn Sie mit der Maus über den Tag fahren. Typischerweise findet die
                                        Schlüsselübergabe um 16 Uhr am Vortag der Reservierung statt und die
                                        Schlüsselrückgabe um 12 Uhr am Tag nach der Reservierung.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseSeven" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        Ja, gemäß der DSGVO haben Sie das Recht, Ihre Daten löschen zu lassen. Sie
                                        können Ihr Profil
                                        selbst löschen, indem Sie in Ihrem Profil auf "Mein Profil unwiderruflich
                                        löschen" klicken.
                                        Dabei werden alle Ihre persönlichen Daten und Reservierungen gelöscht.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseEight" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        Nach einem Klick darauf erhalten Sie eine E-Mail mit allen über Sie
                                        gespeicherten Daten,
