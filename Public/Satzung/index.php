        ...
        <div class="container" style="margin-top: 6rem;">
            ...
            <div class="row mt-4">
                <div class="col-md-6 mb-4">
                    <div class="card-wrapper">
                        <div class="card-box align-left">
                            <h4 class="card-title mbr-fonts-style mb-3 display-5"><strong>Feuerwehr Satzung</strong>
                            </h4>
                            ...
                            <div class="mbr-section-btn mt-3">
                                <a class="btn btn-primary display-4"
                                    href="Datei/FW_Satzung_nach-GVE_16.09.2024_Waldems.pdf" target="_blank">
                                    Herunterladen
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card-wrapper">
                        <div class="card-box align-left">
                            <h4 class="card-title mbr-fonts-style mb-3 display-5"><strong>Förderverein Satzung</strong>
                            </h4>
                            <p class="mbr-text mbr-fonts-style mb-3 display-7">
